...
export class IconObject extends DrawnObjectBase {
  public constructor(
    ...
    if (typeof urlOrImg === "string") {
      ...
      // it's an existing DrawableImage
  ...
  public get image(): DrawableImage | undefined {
    return this._image;
  }
  ...
  public get resizesImage() {
    return this._resizesImage;
  }
  ...
  protected _resize() {
    //=== YOUR CODE HERE ===
    if (this.resizesImage) return;
    if (this.image?.canvasImage) {
