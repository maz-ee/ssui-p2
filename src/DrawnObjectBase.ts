...
//
// This class provides implementation or partial implementation in six categories:
...
export class DrawnObjectBase {
  ...
  public get position(): PointLiteral {
  ...
  public get wConfig(): SizeConfigLiteral {
    return this._wConfig;
  }
  ...
  public wIsFixed(): boolean {
    return this._wConfig.min === this._wConfig.max;
  }
  ...
  public get hConfig(): SizeConfigLiteral {
    return this._hConfig;
  }
  ...
  public get parent(): DrawnObjectBase | undefined {
    return this._parent;
  }
  ...
  public get children(): readonly DrawnObjectBase[] {
  ...
  public addChildAt(
    newChild: DrawnObjectBase,
    indx: number = this.children.length
  ): DrawnObjectBase {
  ...
  protected _measureText(
    ...
    if (!ctx) {
      ...
      if (!ctx)
        throw new Error(
          "No drawing context to measure text with in " +
  ...
  protected _damageFromChild(
    child: DrawnObjectBase,
    xInChildCoords: number,
    yInChildCoords: number,
    wv: number,
    hv: number
  ): void {
    //=== YOUR CODE HERE ===
  ...
  public get debugID(): number {
    return this._debugID;
  }

  // Counter for ID assignment
  private static _nextDebugID: number = 0;
  private static _genDebugID(): number {
    return DrawnObjectBase._nextDebugID++;
  }
  ...
  public debugString(withChildren: boolean = true): string {
    ...
    else result += `#children:${this._children.length}]`;
    return result;
  }
