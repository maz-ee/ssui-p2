...
export class TextObject extends DrawnObjectBase {
  ...
  public get padding(): SizeLiteral {
  ...
  public get renderType(): RenderOp {
    return this._renderType;
  }
  public set rederType(v: RenderOp) {
    this._renderType = v;
  }
  ...
  public get color(): string | number {
    return this._color;
  }
  public set color(v: string | number) {
    this._color = v;
  }
  ...
  protected _recalcSize(ctx?: DrawContext): void {
    ...
    this._h = dims.h + this.padding.h + this.padding.h;
  ...
  protected override _drawSelfOnly(ctx: DrawContext): void {
    ...
    try {
      ...
      // get text start coords
      const x = this.padding.w;
      const y =
        this._measureText(this.text, this.font, ctx).baseln + this.padding.h;

      if (this.renderType === "stroke") {
        ctx.strokeText(this.text, x, y);
      } else if (this.renderType === "fill") {
